...
## Remove Similar Attributes
Certain attributes are representd multiple ways in different attributes.  Remove the attributes that essentially represent the same data.
```{r remove-dup-attrs}
